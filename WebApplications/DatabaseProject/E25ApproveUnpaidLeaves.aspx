<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="E25ApproveUnpaidLeaves.aspx.cs" Inherits="DatabaseProject.ApproveUnpaidLeaves" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="page-container">
            ...
            <div class="page-header">
                <h2>&#9989; Approve / Reject Unpaid Leaves</h2>
                <p>Review and action unpaid leave requests submitted by employees.</p>
            </div>
