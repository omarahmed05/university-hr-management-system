...
{
    public partial class MedicalLeaveApplication : Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                ShowMessage("FAILED", "Type required", "Select sick or maternity leave.");
                return;
            }

            if (!fuDocument.HasFile || String.IsNullOrWhiteSpace(txtDocDescription.Text))
            {
                ShowMessage("FAILED", "Document required", "Medical leave requires document upload and description.");
                return;
            }
            ...
            try
            {
                ...
                bool insurance = cbInsurance.Checked;
                ...
                string uploadFolder = Server.MapPath("~/Uploads/Medical/");
                ...
                cmd.Parameters.AddWithValue("@disability_details", String.IsNullOrEmpty(disability) ? (object)DBNull.Value : disability);
                ...
                ShowMessage("SUCCESS", "Medical leave submitted", "Medical Doctor and HR will review your request.");
